    ...
    <nav>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <router-link v-for="subvue in $store.state.subscribedSubvues"
                             :key="subvue.permalink"
                             :to="{ name: 'Subvue', params: {name: subvue.permalink} }">{{ subvue.name }}</router-link>
        ...
        <router-link v-if="$store.state.isUserLoggedIn" style="float:right" :to="{ name: 'Settings', params: {} }">Settings</router-link>
        <router-link v-if="$store.state.isUserLoggedIn" style="float:right" :to="{ name: 'Profile', params: {} }">Profile</router-link>
    </nav>
</template>
